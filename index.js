...
console.log(createMenuItem('waffles', 5, 'Brunch'));
...
reviews.push({name: 'Reyna', rating: 5, feedback: 'this place is great! Delicious food, awesome atmosphere, would recommend!'});
